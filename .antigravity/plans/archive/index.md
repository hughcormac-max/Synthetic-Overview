...
> **Location:** `.antigravity/plans/archive/index.md`
...
Archived plans are categorized by year under `.antigravity/plans/archive/YYYY/PLAN-XXX.md`.

```text
.antigravity/plans/archive/
...
4. Move the file from `.antigravity/plans/active/PLAN-XXX.md` to `.antigravity/plans/archive/YYYY/PLAN-XXX.md`.

...
## 🏃 1. Active Sprint / Immediate Priorities

| Task ID | Item & Description | Module | Priority | Status | Associated Plan |
| :--- | :--- | :--- | :--- | :--- | :--- |
| `TASK-001` | **Project Stack Specialization:** Configure language-specific package manifests, linter, and test suites. | Root / Config | High | ⏳ Pending | `PLAN-001` |
| `TASK-002` | **Domain Layer Inception:** Define initial domain entities and calculation contracts. | `src/core/` | High | ⏳ Pending | `PLAN-002` |

---

## 📋 2. In-Flight Active Plans
...
## 📥 4. Backlog / Next Up Queue

- [ ] Add pre-commit git hooks for linting and zero-LaTeX validation.
- [ ] Configure CI automated test execution workflow.
- [ ] Implement initial domain module tests.
